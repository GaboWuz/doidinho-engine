...
class Stage extends FlxGroup
{
	...
	private function lapoluzStepHit(curStep:Int):Void
	{
	    switch(curStep)
	    {
	        ...
	        case 356: tweenCamZoom(0.715, 0.6);
	        case 358: tweenCamZoom(0.815, 0.6);
	        case 362: tweenCamZoom(0.715, 0.6);
	        case 364: tweenCamZoom(0.635, 0.6);
	        case 380: tweenCamZoom(0.605, 0.6);
	        case 382: tweenCamZoom(0.635, 0.6);
	        case 384: tweenCamZoom(0.715, 0.6);
	        case 512: tweenCamZoom(1.0, 0.6);
	        case 539: tweenCamZoom(1.25, 0.6);
	        case 544: tweenCamZoom(1.0, 0.6);
	        case 576: tweenCamZoom(1.15, 0.6);
	        case 640: tweenCamZoom(1.0, 0.6);
	        case 667: tweenCamZoom(1.25, 0.6);
	        case 672: tweenCamZoom(1.0, 0.6);
	        case 704: tweenCamZoom(1.15, 0.6);
	        case 768: tweenCamZoom(1.0, 0.6);
	        case 910: tweenCamZoom(0.915, 0.6);
	        case 918: tweenCamZoom(0.815, 0.6);
	        case 960: tweenCamZoom(1.0, 0.6);
	        case 976: tweenCamZoom(0.915, 0.6);
	        case 1008: tweenCamZoom(0.635, 0.6);
	        case 1016: tweenCamZoom(0.605, 0.6);
	        case 1026: tweenCamZoom(0.635, 0.6);
	        case 1068: tweenCamZoom(0.915, 0.6);
	        case 1090: tweenCamZoom(0.815, 0.6);
	        case 1136: tweenCamZoom(0.605, 0.6);
	        case 1152: tweenCamZoom(0.815, 0.6);
	        case 1280: tweenCamZoom(1.15, 0.6);
	        case 1344: tweenCamZoom(1.25, 0.6);
	        case 1408: tweenCamZoom(0.635, 0.6);
	    }
	}
